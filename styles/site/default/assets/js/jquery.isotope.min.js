! function(t, i, s) {
    ...
    var e, n, o, r = t.document,
        ...
        u = function(t) {
            var i, s = r.documentElement.style;
            if ("string" == typeof s[t]) return t;
            t = h(t);
            for (var e = 0, n = l.length; e < n; e++)
                if ("string" == typeof s[i = l[e] + t]) return i
        },
        c = u("transform"),
    ...
    if (a)
        for (e in f) a.hasOwnProperty(e) || a.addTest(e, f[e]);
    else {
        a = t.Modernizr = {
            _version: "1.6ish: miniModernizr for Isotope"
        };
        var m, p = " ";
        for (e in f) m = f[e](), a[e] = m, p += " " + (m ? "" : "no-") + e;
        i("html").addClass(p)
    }
    if (a.csstransforms) {
        var y = a.csstransforms3d ? {
            ...
            g = function(t, s, e) {
                var n, o, r = i.data(t, "isoTransform") || {},
                    a = {},
                    h = {};
                for (n in a[s] = e, i.extend(r, a), r) o = r[n], h[n] = y[n](o);
                var l = (h.translate || "") + (h.scale || "");
                i.data(t, "isoTransform", r), t.style[c] = l
            };
    ...
    i.Isotope.settings = {
        ...
        _getAtoms: function(t) {
            ...
            return s = s.filter(function(t, i) {
                return 1 === i.nodeType
            }), this.usingTransforms && (e.right = 0, e.top = 0), s.css(e).addClass(this.options.itemClass), this.updateSortData(s, !0), s
        },
        _init: function(t) {
        ...
        option: function(t) {
            ...
            if (i.isPlainObject(t))
                for (var e in this.options = i.extend(!0, this.options, t), t) this[s = "_update" + h(e)] && this[s]()
        },
        ...
        updateSortData: function(t, s) {
            ...
            t.each(function() {
                for (var t in e = i(this), n = {}, r) n[t] = s || "original-order" !== t ? r[t](e, o) : i.data(this, "isotope-sort-data")[t];
        ...
        _sort: function() {
            ...
            this.$filteredAtoms.sort(function(e, n) {
                var o = i(e, t),
                    r = i(n, t);
        ...
        _pushPosition: function(t, i, s) {
            i = Math.round(i + this.offset.right), s = Math.round(s + this.offset.top);
        ...
        _processStyleQueue: function(t, s) {
            var e, r, h, l, u = this.isLaidOut && this.isUsingJQueryAnimation ? "animate" : "css",
                c = this.options.animationOptions,
                d = this.options.onLayout;
            if (r = function(t, i) {
                    i.$el[u](i.style, c)
                }, this._isInserting && this.isUsingJQueryAnimation) r = function(t, i) {
                e = i.$el.hasClass("no-transition") ? "css" : u, i.$el[e](i.style, c)
            };
            else if (s || d || c.complete) {
                var f = !1,
                    m = [s, d, c.complete],
                    p = this;
                if (h = !0, l = function() {
                        if (!f) {
                            for (var i, s = 0, e = m.length; s < e; s++) "function" == typeof(i = m[s]) && i.call(p.element, t, p);
                            f = !0
                        }
                    }, this.isUsingJQueryAnimation && "animate" === u) c.complete = l, h = !1;
                else if (a.csstransitions) {
                    for (var y, g = 0, _ = this.styleQueue[0], v = _ && _.$el; !v || !v.length;) {
                        if (!(y = this.styleQueue[g++])) return;
                        v = y.$el
                    }
                    parseFloat(getComputedStyle(v[0])[o]) > 0 && (r = function(t, i) {
                        i.$el[u](i.style, c).one(n, l)
                    }, h = !1)
                }
            }
            i.each(this.styleQueue, r), h && l(), this.styleQueue = []
        },
        resize: function() {
        ...
        destroy: function() {
            ...
            this.$allAtoms.removeClass(i.hiddenClass + " " + i.itemClass).each(function() {
                var i = this.style;
                i.position = "", i.top = "", i.right = "", i.opacity = "", t && (i[c] = "")
            });
            var s = this.element[0].style;
        ...
        _getSegments: function(t) {
            var i, s = this.options.layoutMode,
                ...
                o = t ? "rows" : "cols",
                r = this.element[n](),
                a = this.options[s] && this.options[s][e] || this.$filteredAtoms["outer" + h(n)](!0) || r;
            i = Math.floor(r / a), i = Math.max(i, 1), this[s][o] = i, this[s][e] = a
        },
        ...
        return n || a(), e.bind("load.imagesLoaded error.imagesLoaded", function t(s) {
            var h = s.target;
            h.src !== o && -1 === i.inArray(h, r) && (r.push(h), --n <= 0 && (setTimeout(a), e.unbind(".imagesLoaded", t)))
        }).each(function() {
            var t = this.src;
